...
import kotlinx.android.synthetic.main.fragment_city_two.view.*
...
class CityTwoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.btn_find_city_two_find_photographer.setOnClickListener {
            val intent = Intent(context, FindPhotographerActivity::class.java)
            val order = Order()
            order.city = "Yogyakarta"
    ...
    companion object {
         ...
         * @return A new instance of fragment CityTwoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CityTwoFragment().apply {
        ...
        fun newInstance() = CityTwoFragment()
    }
}
