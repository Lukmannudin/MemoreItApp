...
class PhotoSessionOneFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_photo_session_one, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment PhotoSessionOneFragment.
         */
        ...
        fun newInstance() = PhotoSessionOneFragment()
    }
